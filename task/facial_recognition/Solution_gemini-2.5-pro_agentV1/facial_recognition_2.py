...
cv2.imwrite("gemini_solution_2.png", cv2.cvtColor(crowd_image, cv2.COLOR_RGB2BGR))

# Write to CSV
with open("gemini_solution_2.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Processing complete. Output saved to gemini_solution_2.png and gemini_solution_2.csv")
